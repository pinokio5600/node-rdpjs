...
function desktopResizeEvent(width, height) {
	const buffer = Buffer.alloc(8); // 8바이트 크기

    buffer.writeUInt16LE(0x0010, 0); // Update Type: TS_UPDATE_DESKTOP_SIZE
    buffer.writeUInt16LE(0x0000, 2); // Padding (Reserved)
    buffer.writeUInt16LE(width, 4);  // New Desktop Width
    buffer.writeUInt16LE(height, 6); // New Desktop Height
