...
var UpdateType = {
	...
	UPDATETYPE_DESKTOP_RESIZE : 0x0004
};
...
function desktopResizeEvent(opt) {
	var self = {
		width: new type.UInt16Le(),
		height: new type.UInt16Le(),
...
function clientResizeEventPDU(data, opt) {
	var self = {
		__PDUTYPE2__: PDUType2.PDUTYPE2_UPDATE,
		updateType : new type.UInt16Le(UpdateType.UPDATETYPE_DESKTOP_RESIZE),
		updateData: data || new type.Factory(function(s){
			self.updateData = new type.Component([]);
		})
    };
...
module.exports = {
		...
		desktopResizeEvent : desktopResizeEvent,
		clientResizeEventPDU: clientResizeEventPDU,
