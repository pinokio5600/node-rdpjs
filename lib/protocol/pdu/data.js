...
function desktopResizeEvent(width, height) {
	const self = {
        __INPUT_MESSAGE_TYPE__: InputMessageType.DESKTOP_RESIZE_EVENT,
        width: new type.UInt16Le(width),
        height: new type.UInt16Le(height),
        padding: new type.UInt16Le(0), // 패딩 필드
    };
